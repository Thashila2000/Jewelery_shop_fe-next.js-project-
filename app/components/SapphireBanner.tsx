...
export default function SapphireBanner() {
    ...
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .sap-desc { display: none !important; }
      ...
      {/* GUARANTEED BOTTOM SPACING: 
        Using padding-bottom (pb) instead of margin to prevent CSS collapse.
        Added bg-white to ensure the gap is the correct color.
      */}
  ...
  style={{ 
    ...
    fontWeight: 200, 
    fontStyle: "italic", 
    color: "rgba(130,170,235,0.88)", 
    margin: "0 0 20px" 
  }}
>
  <span style={{ fontSize: "1.3em", fontWeight: 400, fontStyle: "normal", marginRight: "4px" }}>
    10%
  </span> 
  Off — This Season Only
</motion.p>
