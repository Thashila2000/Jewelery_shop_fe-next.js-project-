    ...
    <>
      <style>{`
        ...
        .col-title {
          ...
          letter-spacing: -0.01em; color: #1a1a1a; margin-bottom: 24px;
        }
        ...
        .col-subtitle {
          ...
          max-width: 500px; margin: 0 auto; text-transform: uppercase;
        }
        ...
        .col-btn { display: inline-flex; align-items: center; gap: 10px; font-family: 'DM Sans', sans-serif; font-size: 10px; font-weight: 500; letter-spacing: 0.3em; text-transform: uppercase; color: #ffffff; background: #b18d2b; border: none; padding: 14px 28px; cursor: pointer; transition: background 0.3s ease; text-decoration: none; }
      ...
      <div className="col-page">
        ...
        >
          ...
          />
          <p className="col-subtitle">Handcrafted Masterpieces curated for the modern era</p>
        </motion.header>
